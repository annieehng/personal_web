...
function Projects() {
  const [areFirstCardsVisible, setAreFirstCardsVisible] = useState(false);

  useEffect(() => {
    const timer = setTimeout(() => {
      setAreFirstCardsVisible(true);
    }, 100);
  ...
  return (
    <div className="projects-page">
      ...
      <div className="project-container">
        <div className={`project-card ${areFirstCardsVisible ? "fade-in visible" : ""}`}>
          <div className="project-content reverse-layout">
            <img src={project1Image} alt="McGill Happenings project" className="project-image" />
            <div className="project-text">
              ...
              <div>
                ...
                <a href="https://github.com/annieehng/mcgill-happenings" target="_blank" rel="noopener noreferrer">
                  View Github Link
                </a>
              </div>
            </div>
        ...
        <div className={`project-card ${areFirstCardsVisible ? "fade-in visible" : ""}`}>
          <div className="project-content normal-layout">
            <img src={project2Image} alt="Dangogo project" className="project-image" />
            <div className="project-text">
              ...
              <a href="https://github.com/annieehng/dangogo" target="_blank" rel="noopener noreferrer">
                View Github Link
              </a>
            </div>
          </div>
        ...
        <div className="project-card fade-in">
          <div className="project-content reverse-layout">
            ...
            <div className="project-text">
              ...
              <p>
                Do you have trouble deciding what makeup best suits your facial features? With the click of a button, 
                our application will scan your face, determine what type of face shape you have, and display a contour
                and blush pattern directly on your face! Just grab those makeup brushes and follow the pattern.
              </p>
              <p>
                My team and I built a facial recognition program trained to identify the user's face shape and place the 
              ...
              <a href="https://github.com/annieehng/ContouringYOU" target="_blank" rel="noopener noreferrer">
                View Github Link
              </a>
            </div>
          </div>
